...
def main():
    ...
    # =================================================================
    # 1. MEDICINE LOOKUP  (primary feature — right below hero)
    # =================================================================
    st.markdown('<div class="section-title">Medicine Lookup</div>', unsafe_allow_html=True)
    ...
    # =================================================================
    # 2. PRESCRIPTION CART  (unchanged logic)
    # =================================================================
    ...
    # =================================================================
    # 3. MONTHLY COST CALCULATOR  (unchanged logic)
    # =================================================================
    st.markdown('<hr class="divider">', unsafe_allow_html=True)
    st.markdown('<div class="section-title">Monthly Cost Calculator</div>', unsafe_allow_html=True)
        ...
        if not calc_data.empty:
            ...
            if generic:
                ...
                if cheapest_generic["name"] != calc_med and cheapest_generic["price_pkr"] < unit_price:
                    ...
                    <div style="margin-top:0.75rem; padding:0.75rem 1rem; background:{COLORS['green_dim']}; border:1px solid {COLORS['green']}44; border-radius:8px;">
    ...
    if user_city:
        st.markdown(
            f'<div class="section-title">Pharmacies Near You — '
            f'<span class="pill pill-green">{user_city}</span></div>',
            unsafe_allow_html=True,
        )
    else:
        st.markdown(
            '<div class="section-title">Pharmacies Near You</div>',
            unsafe_allow_html=True,
        )
    ...
    # =================================================================
    # 5. ANALYTICS  (collapsed expander)
    # =================================================================
    st.markdown('<hr class="divider">', unsafe_allow_html=True)

    with st.expander("Analytics & Detailed Data", expanded=False):
